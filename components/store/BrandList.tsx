...
const BrandList = ({ brands }: Props) => {
  ...
  return (
    <div className="bg-transparent py-12 px-4 text-center">
      ...
      >
        <CarouselContent className="-ml-2 md:-ml-4">
          {brands?.map((item) => (
            ...
            >
              <div
                className="w-20 h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 flex items-center justify-center rounded-full overflow-hidden cursor-pointer bg-[#e5e4e4]"
